...
// mongo db cooncetion code strat
...
// const uri =
//   "mongodb+srv://coffeMaster:ador123@cluster0.krhx2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
    ...
    app.put("/coffee/:id", async (req, res) => {
      ...
      const coffee = {
        $set: {
          ...
          coffeeQuantity: updatedCoffee.coffeeQuantity,
          ...
          coffeePhoto: updatedCoffee.coffeePhoto,
        },
      };
...
app.listen(port, () => {
  console.log(`Coffe Server listening on port ${port}`);
});
